<?php
    ...
    $calltoaction  = FlipBox::getInfo($id);
...
<html>
    <head>
        ...
        <title><?php echo $lang['table']['editflipbox'];?> | <?php echo $applicationConfig['name']; ?></title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <?php echo $lang['table']['editflipbox'];?> - <?php echo $calltoaction['title']; ?>
                        <small><?php echo $lang['table']['flipbox'];?></small>
                    </h1>
                    <ol class="breadcrumb">
                        
                        <li><a href="#"><i class="fa fa-user"></i><?php echo $lang['table']['flipbox'];?></a></li>
                        <li class="active"><?php echo $lang['table']['editflipbox'];?></li>
                    </ol>
                </section>
                                    ...
                                    <form role="form" action="work.php?action=edit" method="post" enctype='multipart/form-data'>
                                        ...
                                        <div class="box-body">
                                              <div class="form-group">
                                                    ...
                                                    <p class="help-block">
                                                        <?php if($calltoaction['icon']): ?>
                                                        <img style="border: 1px solid #000;" src="<?php echo FlipBox::getImageUrl($calltoaction['icon']); ?>" width="150" /> | 
                                                        <a href="<?php echo FlipBox::getImageUrl($calltoaction['icon']); ?>" target="_blank">View Original icon</a> | 
                                        ...
                                        <div class="form-group">
                                            <label><?php echo $lang['table']['buttontex'];?> </label>
                                            <input type="text" value="<?php echo $calltoaction['button_text']; ?>" class="form-control" name="button_text" placeholder="Title ..."/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label><?php echo $lang['table']['buttonurl'];?> </label>
                                            <input type="text" value="<?php echo $calltoaction['button_url']; ?>" class="form-control" name="button_url" placeholder="Title ..."/>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                          <button type="submit" class="btn btn-primary"><?php echo $lang['table']['editflipbox'];?></button>
                                      </div>

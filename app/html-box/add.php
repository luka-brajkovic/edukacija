        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <?php echo $lang['table']['addhtmlbox'];?>
                        <small><?php echo $lang['table']['htmlbox'];?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#"><i class="fa fa-user"></i><?php echo $lang['table']['htmlbox'];?></a></li>
                        <li class="active"><?php echo $lang['table']['addhtmlbox'];?></li>
                    </ol>
                </section>
                                ...
                                <div class="box-body">
                                    <form role="form" action="work.php?action=add" method="post" enctype='multipart/form-data'>
                                       ...
                                       <div class="box-footer">
                                          <button type="submit" class="btn btn-primary"><?php echo $lang['table']['addhtmlbox'];?></button>
                                       </div>

...
<?php
    ...
    $calltoactions  = Course::getAllQuestionsForCourse($data['course_id']);
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                                        ...
                                        <?php 
                                          foreach($calltoactions as $calltoaction) {
                                           ...
                                           <tr class="table-row" id="item_<?php echo $calltoaction['id']; ?>">
                                              ...
                                              <td>
                                                <a href="<?php echo APP_URL . 'course/course_question_edit.php?id=' . $calltoaction['id']; ?>" class="btn btn-sm btn-primary"><?php echo $lang['table']['edit'];?></a>
                                                <a href="#" class="btn btn-sm btn-info handle"><?php echo $lang['table']['reorder'];?></a>
                                                <a href="<?php echo  APP_URL ."course/course_answers.php?id=" . $calltoaction['id'];?>" class="btn btn-sm btn-info handle"><?php echo "add ansswers ( ".$calltoaction['a_num']." )";?></a>
                            ...
                            <a href="<?php echo APP_URL."course/course_question_add.php?course_id=".$data['course_id']; ?>" class="btn btn-lg btn-success"><?php echo $lang['table']['addcourse'];?></a>
                        </div>
                    </div>

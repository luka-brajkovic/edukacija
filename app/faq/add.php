...
<html>
    <head>
        ...
        <title><?php echo $lang['table']['addfaq'];?> </title>
                                ...
                                <div class="box-body">
                                    <form role="form" action="work.php?action=add" method="post" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" class="form-control" name="answer" rows="3" placeholder="Answer ..."></textarea>
                                        </div>
                                       ...
                                       <div class="box-footer">
                                          <button type="submit" class="btn btn-primary"><?php echo $lang['table']['addfaq'];?> </button>
                                       </div>

...
<?php
    ...
    $calltoactions  = Seminar::getAllQuestionsForSeminar($data['course_id']);
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover resizeble_course" id="category-table" parent="<?php echo $parentID; ?>">
                                        <input type="hidden" id="table-for-order" value="2" >
                                        <tr class="header">
                                            <th data-field="id">ID</th>
                                            <th data-field="name"><?php echo $lang['table']['name'];?></th>
                                            <th data-field="name"><?php echo $lang['table']['isactive'];?></th>
                                        ...
                                        <?php 
                                          foreach($calltoactions as $calltoaction) {
                                           ...
                                           <tr class="table-row" id="item_<?php echo $calltoaction['id']; ?>">
                                                ...
                                                <td><?php echo ($calltoaction['active'])? "Yes":"No"; ?></td>
                                              
                                              
                                              <td>
                                                <a href="<?php echo APP_URL . 'seminar/course_question_edit.php?id=' . $calltoaction['id']; ?>" class="btn btn-sm btn-primary"><?php echo $lang['table']['edit'];?></a>
                                                <a href="#" class="btn btn-sm btn-info handle"><?php echo $lang['table']['reorder'];?></a>
                                                <a href="<?php echo  APP_URL ."seminar/course_answers.php?id=" . $calltoaction['id'];?>" class="btn btn-sm btn-info handle"><?php echo "add ansswers ( ".$calltoaction['a_num']." )";?></a>
                            ...
                            <a href="<?php echo APP_URL."seminar/course_question_add.php?course_id=".$data['course_id']; ?>" class="btn btn-lg btn-success"><?php echo $lang['table']['addcourse'];?></a>
                        </div>
                    </div>

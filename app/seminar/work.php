<?php
  ...
  switch($action) {
    ...
    case "edit":
      ...
      $image          = Utils::imageUpload('image', Seminar::getImagePath(), Utils::generateUrl($data['title']) . "");
      if(!empty($image)) {
    ...
    case "remove_2":
      ...
      $request->redirect(APP_URL . "/seminar/course_answers.php?id=" . $calltoaction->course_question_id);
      break;
      ...
      Seminar::updateOrder($items ,$tableName);
      break;
      ...
      $object->mtime = time();
      $object->save();
      $request->redirect(APP_URL . "seminar/course_questions.php?course_id=" . $data['course_id']);
      break;
      ...
      $object->mtime = time();
      $object->save();
      $request->redirect(APP_URL . "seminar/course_questions.php?course_id=" . $object->course_id);
      break;
      ...
      $request->redirect(APP_URL . "seminar/course_answers.php?id=" . $data['course_question_id']);
      break;
      ...
      $usersData  = Seminar::GetUsersForSeminar($courseid);
      ...
      $request->redirect(APP_URL . "seminar/cours_user.php?id=".$courseid);   

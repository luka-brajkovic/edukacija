...
<?php
    ...
    $calltoactions  = Seminar::getAllAnswersForQuestion($data['id']);
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                                        ...
                                        <?php 
                                          foreach($calltoactions as $calltoaction) {
                                           ...
                                           <tr class="table-row" id="item_<?php echo $calltoaction['id']; ?>">
                                              ...
                                              <td>
                                                <a href="<?php echo APP_URL . 'seminar/course_answers_edit.php?id=' . $calltoaction['id']; ?>" class="btn btn-sm btn-primary"><?php echo $lang['table']['edit'];?></a>
                                                <a href="#" class="btn btn-sm btn-info handle"><?php echo $lang['table']['reorder'];?></a>
                                                
                                                <?php   echo "<a href=". APP_URL ."seminar/work.php?action=remove_2&id=" . $calltoaction['id']." class='btn btn-sm btn-danger'>". $lang['table']['remove']."</a>"; ?>
                            ...
                            <a href="<?php echo APP_URL."seminar/course_answers_add.php?id=".$data['id']; ?>" class="btn btn-lg btn-success"><?php echo $lang['table']['addseminar'];?></a>
                        </div>
                    </div>

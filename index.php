...
<div class="wrapper"> 
	...
	<div class="main-section">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<?php include 'web-includes/vesti-naslovna.php'; ?>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<?php include 'web-includes/aktivnosti-naslovna.php'; ?>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<?php include 'web-includes/najave-naslovna.php'; ?>
					</div>
				</div>
			</div>
		</div> 
        ...
        <?php include 'web-includes/desavanja-naslovna.php'; ?>
		
        <?php include 'web-includes/fun-facts-naslovna.php'; ?>
		
		
		<div class="page-section" style="margin-bottom:40px; margin-top: 40px;">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="cs-fancy-heading" style="margin-bottom:40px;">
							<h6 style="font-size:14px !important; color:#999 !important; text-transform:uppercase !important;">Sponzori</h6>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
